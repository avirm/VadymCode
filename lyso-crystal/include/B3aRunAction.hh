...
class B3aRunAction : public G4UserRunAction
{
  public:
    ...
    //void SumEnergy(G4double energy) { fEdep += energy; };
    void CountOneHitDeposit() {fOneHitDeposit +=1;};
    void CountMultiHitsDeposit() {fMultiHitsDeposit +=1;};
    void CountParticlyDeposit() {fParticlyDeposit +=1;};

private:
    G4Accumulable<G4int>    fGoodEvents;
    G4Accumulable<G4double> fSumDose;
    //G4Accumulable<G4double> fEdep;
    G4int fOneHitDeposit;
    G4int fMultiHitsDeposit;
    G4int fParticlyDeposit;
};
